...
export const ErrorCodes = {
  ...
  // Security errors
  INVALID_SECRETS_KEY: 'INVALID_SECRETS_KEY',
  SECRETS_KEY_ROTATION_FAILED: 'SECRETS_KEY_ROTATION_FAILED',
  ...
  CREDENTIAL_INJECTION_ATTEMPT: 'CREDENTIAL_INJECTION_ATTEMPT',
} as const;
...
export const ErrorStatusCodes: Record<ErrorCode, number> = {
  ...
  // Security errors (400 Bad Request for validation failures)
  [ErrorCodes.INVALID_SECRETS_KEY]: 400,
  [ErrorCodes.SECRETS_KEY_ROTATION_FAILED]: 500,
  [ErrorCodes.BACKUP_CODE_ALREADY_USED]: 401,
  [ErrorCodes.TOKEN_THEFT_DETECTED]: 401,
  [ErrorCodes.PATH_VALIDATION_FAILED]: 400,
  [ErrorCodes.SYMLINK_NOT_ALLOWED]: 400,
  [ErrorCodes.CREDENTIAL_INJECTION_ATTEMPT]: 400,
};
